    ...
    <div class="main-content">
      ...
      <div v-show="currentPage === 'organizer'" class="content-panel organizer-page">
        ...
        <div v-if="!userStore.token" class="login-container">
          <!-- 登录模式 -->
          <div v-if="!showRegister" class="login-box">
            ...
            <div class="login-footer">
              还没有账户？
              <a class="link-btn" @click="showRegister = true">立即注册</a>
            </div>
          </div>

          <!-- 注册模式 -->
          <div v-else class="login-box register-box">
            <div class="login-icon">📝</div>
            <div class="login-title">主办方注册</div>
            <div class="login-subtitle">创建账户后即可上传和管理活动信息</div>
            ...
            <div class="form-group">
              <label class="form-label">主办方名称 <span class="required">*</span></label>
              <input v-model="registerForm.organizer_name" type="text" class="form-input" placeholder="请输入主办方名称" />
            </div>

            <div class="form-group">
              <label class="form-label">联系人 <span class="required">*</span></label>
              <input v-model="registerForm.contact_person" type="text" class="form-input" placeholder="请输入联系人姓名" />
            </div>

            <div class="form-group">
              <label class="form-label">手机号 <span class="required">*</span></label>
              <input v-model="registerForm.phone" type="text" class="form-input" placeholder="请输入联系电话" />
            </div>

            <div class="form-group">
              <label class="form-label">邮箱 <span class="required">*</span></label>
              <input v-model="registerForm.email" type="text" class="form-input" placeholder="请输入联系邮箱" />
            </div>

            <div class="form-group">
              <label class="form-label">办公地址</label>
              <input v-model="registerForm.address" type="text" class="form-input" placeholder="请输入办公地址（选填）" />
            </div>

            <div v-if="registerError" class="error-msg">{{ registerError }}</div>

            <button class="login-btn register-btn" @click="handleRegister" :disabled="registerLoading">
              {{ registerLoading ? '注册中...' : '注 册' }}
            </button>

            <div class="login-footer">
              已有账户？
              <a class="link-btn" @click="showRegister = false">返回登录</a>
            </div>
          </div>
        </div>
      ...
      <div v-show="currentPage === 'navigation'" class="content-panel navigation-page">
        ...
        <div class="nav-content">
          <div class="map-container">
            ...
            <div v-show="mapLoaded" id="amap-container"></div>
          </div>
...
const handleRegister = async () => {
  ...
  if (!registerForm.username || !registerForm.password || !registerForm.organizer_name || !registerForm.contact_person || !registerForm.phone || !registerForm.email) {
...
const initMap = () => {
  if (!window.AMap) {
    if (window.__amapReady) {
      console.warn('__amapReady 已标记但 AMap 对象未就绪，重新加载脚本')
      mapLoaded.value = false
      return
    }
    console.warn('高德地图 JS API 未加载，等待加载...')
    mapLoaded.value = false
    window.addEventListener('amap-ready', initMap, { once: true })
    return
  }
